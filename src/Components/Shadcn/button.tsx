  ...
  "inline-flex  cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border bg-background text-foreground shadow-xs hover:border-black hover:bg-accent/50  dark:bg-input/30 dark:border-input dark:hover:border-white dark:hover:bg-input/50",
        secondary:
          "border border-border/50 bg-button-secondary text-foreground hover:bg-button-secondary-hover hover:border-black transition-colors duration-200 delay-75 dark:bg-card dark:border-border/50 dark:hover:bg-button-secondary-hover dark:hover:border-white",
        ghost:
